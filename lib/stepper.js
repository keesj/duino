...
var Stepper = function (options) {
  ...
  var inf = options.inf || 8 ; /* TODO replace by HALF4WIRE "const" */
...
Stepper.prototype.valueEncode2 = function (value) {
  ...
  //for negative numbers we need a little more work to 
...
Stepper.prototype.attach = function() {
	this.setInterface(this.inf);
  	this.setPin1(this.pins[0]);
	this.setPin2(this.pins[1]);
	this.setPin3(this.pins[2]);
	this.setPin4(this.pins[3]);
	this.enable(true);
}
